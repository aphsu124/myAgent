...
def apply_excel_style():
    ...
    if not os.path.exists(ICLOUD_EXCEL): return
    try:
        wb = load_workbook(ICLOUD_EXCEL); ws = wb.active
        ...
        for c in range(1, 8):
            ...
            cell.font = h_f; cell.fill = PatternFill('solid', '2E7D32'); cell.alignment = Alignment('center', 'center')
        ...
        ws.cell(1, g_c).font = h_f; ws.cell(1, g_c).fill = PatternFill('solid', '1565C0')
    ...
    except Exception as e: print(f"Excel 樣式應用失敗: {e}")
